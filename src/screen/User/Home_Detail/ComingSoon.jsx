...
const CommingSoonDetail = () => {
  const [activeTab, setActiveTab] = useState('intro');
  const navigation = useNavigation();

  const lessons = [
    { id: '1', title: 'CommingSoon Lesson 1: Self-Discovery' },
    { id: '2', title: 'CommingSoon Lesson 2: Mindfulness in Words' },
    { id: '3', title: 'CommingSoon Lesson 3: The Power of Gratitude' },
    { id: '4', title: 'CommingSoon Lesson 4: Inner Growth' },
    { id: '5', title: 'CommingSoon Lesson 5: Positive Thinking' },
    { id: '6', title: 'CommingSoon Lesson 6: Embracing Change' },
  ];
  ...
  return (
    <View style={styles.container}>
      {/* Background Header */}
      <ImageBackground
        source={require('../../../assets/User/CommingSoon_bg.png')}
...
export default CommingSoonDetail;
